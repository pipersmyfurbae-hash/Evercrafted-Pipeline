...
const PRODUCTS = [
  {
    ...
    phases: [
      { label: "Material Study Cascade — Single Generation",
        ...
        prompt: "Luxury handcrafted faux botanical The Quiet Hour material cascade, premium artificial silk and polyester florals, complete full-length cascade arrangement 26 to 30 inches tall shown in full from top to bottom within frame — camera pulled back far enough to show every stem from top to base, full arrangement visible not cropped not macro — asymmetric cascade formula weighted toward left with heavier density at upper left and trailing stems descending to lower right — six distinct material types all simultaneously visible and individually readable in a single image: five ivory wax-finish silk ranunculus blooms 4 to 5 inches across fully open with 40 to 60 paper-thin concentric petals in tight spiral rings and flat open center distinctly NOT roses NOT peonies, three faux eucalyptus pod sprays (98898.GR) each with 8 to 12 small sage-green rounded pods clustered on arching wire stems showing matte sage-green surface and subtle texture, three deep burgundy faux berry stems (95482.BU) with small tight clusters of round matte deep burgundy berries, deep dark green artificial frosted pine sprays with individual needle strands and silver-white frost on needle tips only not blue not gray, frosted artificial eucalyptus leaf sprays with silver-sage soft finish, single deep burgundy wine velvet ribbon at base of cascade with two generous loops and a long trailing tail descending to lower right showing rich velvet pile surface — all six material types clearly separated with visible space between each type, each material legible at distance, premium artificial polyester and silk construction visible throughout, photographed against pale neutral gray seamless studio background with no texture, front-facing 3/4 view, soft even studio lighting, product catalog photograph --style raw --s 20 --ar 2:3 --v 7 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, close-up, macro photography, cropped arrangement, partial view, roses, peonies, garden roses, gold pods, brass pods, gold balls, ornaments, jingle bells, blue pine, gray pine, illustrated, painted, flat lay, overhead shot, wreath form, circular arrangement, gathered bouquet, florist bouquet"
      }
    ]
  },
  {
