...
const PRODUCTS = [
  {
    ...
    phases: [
      { label: "Material Study Cascade — Single Generation",
        type: "text", typeLbl: "TEXT ONLY · --s 30", typeClass: "tb-text",
        slots: [
          ["Image Prompt", null],
          ["Omni Reference", null],
        ...
        prompt: "Luxury handcrafted faux botanical The Quiet Hour material cascade, premium artificial silk and polyester florals, asymmetric cascade arrangement 26 to 30 inches, weighted left focal zone, full material hierarchy at maximum, all collection species clearly visible and individually readable — five ivory wax-finish silk ranunculus blooms 4 to 5 inches across fully open with matte wax-finish artificial petal texture, three brass-dusted faux magnolia pods showing brushed brass artificial finish at varying sizes, ivory wax-finish artificial berry cluster stems with matte round berries, deep dark green artificial frosted pine sprays with silver-white frost on needle tips only not blue not gray, frosted artificial eucalyptus sprays with silver-sage finish, single deep burgundy wine velvet ribbon with generous loops and long trailing tail at base showing rich velvet nap and formal weight — all stems at varying heights and depths with natural overlap and believable faux construction, asymmetric cascade formula weighted toward 8 to 12 o'clock heavier side with ribbon fall descending at base, each material individually legible and clearly separated from adjacent materials, premium artificial silk and polyester construction visible throughout, photographed against pale neutral gray seamless background, front-facing 3/4 view showing full cascade height and width, soft even studio lighting --style raw --s 30 --ar 2:3 --v 7 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, florist arrangement, bouquet construction, gathered stems, flat lay, overhead shot, wreath form, circular arrangement, perfectly symmetrical, cotton bolls, fluffy white balls, bunny tail grass, blue pine, gray pine, illustrated, painted"
      }
    ]
  },
  {
    ...
    phases: [
      ...
      {
        label: "Brass Magnolia Pods",
        type: "oref", typeLbl: "OREF", typeClass: "tb-oref",
        slots: [
          ["Image Prompt", "Phase 2 output · --iw 2.5"],
          ["Omni Reference", "Brass-dusted magnolia pod stock photo · --ow 260"],
          ["Style Reference", null],
          ["Parameters", "--iw 2.5  --ow 260"],
        ],
        prompt: `[PHASE-2-OUTPUT-URL] Luxury handcrafted faux botanical wreath, premium artificial silk florals, home decor product photography, complete 24-inch circular ring, ivory ranunculus trio established at 11, 9, and 1, now adding three brass-dusted faux magnolia pods anchoring structural weight at 10, 12, and 2 o'clock, pods showing brushed brass-tone artificial finish, pods subordinate in scale to ranunculus but commanding in surface texture, warm LED glow throughout, complete ring visible, lower arc from 5 to 7 clear, photographed flat against pale gray wall front-facing, soft studio daylight upper left, 85mm editorial product photography --iw 2.5 --oref [MAGNOLIA-POD-BRASS-URL] --ow 260 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, flat lay, overhead shot --style raw --s 150 --ar 1:1 --v 7`
      },
      {
  ...
  },
  {
    ...
    phases: [
      ...
      },
      {
        ...
        slots: [
          ["Image Prompt", "Phase 2 output · --iw 2.5"],
          ["Omni Reference", "Brass magnolia pod stock photo · --ow 220"],
          ["Style Reference", "Hero Wreath render · --sw 300"],
          ["Parameters", "--iw 2.5  --ow 220  --sref [HERO] --sw 300"],
        ],
        prompt: `[PHASE-2-GARLAND-URL] Luxury handcrafted faux botanical mantel garland, premium artificial silk florals, home decor product photography, complete 6-foot linear garland, ivory ranunculus distribution established, now adding four brass-dusted faux magnolia pods anchored at center cluster and at quarter points, ivory wax-finish artificial berry clusters scattered through the full length, pods showing brushed brass artificial finish, stems fully layered and overlapping naturally throughout, complete linear coverage with no bare sections, warm LED glow throughout, dual burgundy velvet ribbon trails at each end draping naturally downward, natural mantel sag and gravity, photographed straight-on at mantel height, soft studio daylight upper left, 85mm editorial product photography --iw 2.5 --oref [MAGNOLIA-POD-BRASS-URL] --ow 220 --sref [HERO-WREATH-RENDER-URL] --sw 300 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, flat lay, overhead shot --style raw --s 150 --ar 16:9 --v 7`
      },
    ]
  },
  {
  ...
  },
  {
    ...
    watchOuts: [
      ...
      "If the candles disappear into the ring, describe them more explicitly: 'three ivory pillar candles of graduated heights at the center of the ring.'",
    ...
    phases: [
      {
        ...
        prompt: `Luxury handcrafted faux botanical centerpiece ring, premium artificial polyester and silk greenery, home decor product photography, complete circular grapevine ring base forming a full unbroken 14-inch loop, deep artificial frosted pine and frosted faux eucalyptus covering the full ring with even radial coverage distributed symmetrically around 360 degrees with no directional weighting in any clock position, integrated warm LED light strand woven through the ring with soft warm glow visible, ring styled on a white linen table surface surrounding three ivory pillar candles of graduated heights at the center, photographed from a 3/4 overhead angle showing the full ring and candles from above and slightly to the front, soft studio daylight from upper left, 85mm editorial e-commerce product photography --no fresh flowers, real plants, live botanicals, organic, dew, wilting, florist, fresh-cut --style raw --s 100 --ar 1:1 --v 7`
      },
      {
        ...
        prompt: `[PHASE-1-TABLE-URL] Luxury handcrafted faux botanical centerpiece ring, premium artificial silk florals, home decor product photography, complete 14-inch circular ring, frosted pine and eucalyptus radial base established, now adding four ivory wax-finish faux ranunculus blooms distributed evenly at 12, 3, 6, and 9 o'clock positions around the ring, slightly graduated sizes for gentle visual interest but no single dominant focal point, one brass-dusted faux magnolia pod at 12 o'clock as a structural accent, ivory wax-finish berry clusters scattered through the arc, LED strand warm glow around the full ring, three ivory pillar candles of graduated heights at center, photographed 3/4 overhead on white linen, soft studio daylight upper left, 85mm editorial product photography --iw 2.0 --oref [RANUNCULUS-IVORY-URL] --ow 300 --sref [HERO-WREATH-RENDER-URL] --sw 200 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, florist --style raw --s 150 --ar 1:1 --v 7`
      },
    ]
  },
  {
    ...
    phases: [
      {
        ...
        prompt: `Luxury handcrafted faux botanical candle ring, premium artificial polyester and wire construction, home decor product photography, 5-inch circular ring of frost-silver artificial foliage and compact frosted artificial pine substrate with full ring coverage, one brass-dusted faux magnolia pod as the single dominant accent positioned at 12 o'clock, one small frosted artificial eucalyptus sprig at 9 o'clock as secondary, minimal and architecturally restrained, no LED strand at this scale, ring flat-lay styled on a warm ivory linen surface surrounding a single ivory pillar candle at center, photographed from a 3/4 overhead angle showing the full ring and candle, soft studio daylight from upper left, 85mm editorial e-commerce product photography --sref [HERO-WREATH-RENDER-URL] --sw 150 --no fresh flowers, real plants, live botanicals, organic, dew, wilting, florist, fresh-cut --style raw --s 100 --ar 1:1 --v 7`
      },
    ]
  },
  {
  ...
  },
  {
    ...
    role: "Accent", roleClass: "rb-photo", form: 'Accessory · Physical Product',
    isPhoto: true,
    approach: "No MJ generation. Three physical picks — a brass magnolia pod pick, an ivory wax-finish berry pick, and a frosted pine pick. Same photographic logic as the Ribbon Trio: warm linen surface, Hero Wreath in soft background for collection context.",
    photoDirection: [
